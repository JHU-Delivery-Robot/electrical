...
U 1 1 604C7B44
P 2000 5150
F 0 "#PWR0112" H 2000 5000 50  0001 C CNN
...
U 1 1 604C98A5
P 2000 5250
F 0 "#PWR0113" H 2000 5000 50  0001 C CNN
...
U 1 1 604C1323
P 9350 3050
F 0 "U2" H 9350 3375 50  0000 C CNN
F 1 "TLP291-4" H 9350 3284 50  0000 C CNN
...
U 1 1 604C350F
P 8950 6000
F 0 "#PWR0120" H 8950 5750 50  0001 C CNN
F 1 "GNDD" H 8954 5845 50  0000 C CNN
...
F 1 "+3V3" H 9765 5523 50  0000 C CNN
...
U 1 1 60559405
P 9750 5850
F 0 "R5" H 9820 5896 50  0000 L CNN
F 1 "200" H 9820 5805 50  0000 L CNN
...
U 1 1 6055D350
P 9750 6050
F 0 "#PWR0122" H 9750 5800 50  0001 C CNN
...
U 1 1 605654D6
P 8950 3500
F 0 "#PWR0123" H 8950 3250 50  0001 C CNN
F 1 "GNDD" H 8954 3345 50  0000 C CNN
...
U 1 1 605654E0
P 10200 2350
F 0 "#PWR0124" H 10200 2200 50  0001 C CNN
...
U 1 1 605654E9
P 10000 2600
F 0 "R7" H 10070 2646 50  0000 L CNN
F 1 "200" H 10070 2555 50  0000 L CNN
...
U 1 1 605654F1
P 10000 3250
F 0 "#PWR0125" H 10000 3000 50  0001 C CNN
...
U 1 1 6056E681
P 9750 4800
F 0 "#PWR0126" H 9750 4550 50  0001 C CNN
F 1 "GNDD" H 9754 4645 50  0000 C CNN
...
U 1 1 6056E68A
P 8900 4100
F 0 "#PWR0127" H 8900 3950 50  0001 C CNN
...
U 1 1 6056E693
P 9750 4600
F 0 "R9" H 9820 4646 50  0000 L CNN
F 1 "1k" H 9820 4555 50  0000 L CNN
...
U 1 1 605A50CB
P 8950 3350
F 0 "R8" H 9020 3396 50  0000 L CNN
F 1 "75" H 9020 3305 50  0000 L CNN
...
U 1 1 605A5DFC
P 9750 4100
F 0 "#PWR0128" H 9750 3950 50  0001 C CNN
...
U 1 1 60553263
P 8950 5850
F 0 "R4" H 9020 5896 50  0000 L CNN
F 1 "75" H 9020 5805 50  0000 L CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 8880 5850 50  0001 C CNN
...
F 1 "TLP291-4" H 9350 4534 50  0000 C CNN
F 2 "Package_SO:SOIC-16_4.55x10.3mm_P1.27mm" H 9150 4100 50  0001 L CIN
F 3 "https://toshiba.semicon-storage.com/info/docget.jsp?did=12858&prodName=TLP291-4" H 9350 4300 50  0001 L CNN
	2    9350 4300
	1    0    0    -1  
$EndComp
$Comp
...
U 3 1 6057CAEA
P 9350 5550
F 0 "U2" H 9350 5875 50  0000 C CNN
F 1 "TLP291-4" H 9350 5784 50  0000 C CNN
F 2 "Package_SO:SOIC-16_4.55x10.3mm_P1.27mm" H 9150 5350 50  0001 L CIN
F 3 "https://toshiba.semicon-storage.com/info/docget.jsp?did=12858&prodName=TLP291-4" H 9350 5550 50  0001 L CNN
	3    9350 5550
	1    0    0    -1  
$EndComp
...
U 1 1 605ADED2
P 10300 2950
F 0 "Q1" H 10491 2996 50  0000 L CNN
F 1 "2N3904" H 10491 2905 50  0000 L CNN
F 2 "Package_TO_SOT_SMD:SOT-23" H 10500 2875 50  0001 L CIN
F 3 "https://www.onsemi.com/pdf/datasheet/mmbt3904lt1-d.pdf" H 10300 2950 50  0001 L CNN
	1    10300 2950
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 605AE317
P 10400 2500
F 0 "R6" H 10470 2546 50  0000 L CNN
F 1 "200" H 10470 2455 50  0000 L CNN
...
Wire Wire Line
	2350 3950 3600 3950
Text Notes 11000 2750 3    50   ~ 0
Use equivalent surface-mount \ntransistor MMBT3904.
Text Notes 1500 4300 0    50   ~ 0
R3 likely not needed --- component kept 'just in case'.\nLeave unpopulated if unused.
$Comp
L Device:C C8
U 1 1 605DB5D4
P 5250 6250
F 0 "C8" H 5365 6296 50  0000 L CNN
F 1 "C" H 5365 6205 50  0000 L CNN
F 2 "Capacitor_SMD:C_0201_0603Metric" H 5288 6100 50  0001 C CNN
...
U 1 1 605DB6A7
P 5250 6100
F 0 "#PWR0129" H 5250 5950 50  0001 C CNN
...
U 1 1 605DB87F
P 5250 6400
F 0 "#PWR0130" H 5250 6150 50  0001 C CNN
...
Decoupling, motor-controller-side \npower.  Place close to I2C isolator.
$Comp
L power:GND #PWR0131
U 1 1 605E6744
P 6000 6400
...
U 1 1 605E6B71
P 6000 6150
F 0 "D1" V 6038 6033 50  0000 R CNN
F 1 "LED" V 5947 6033 50  0000 R CNN
F 2 "LED_SMD:LED_0603_1608Metric" H 6000 6150 50  0001 C CNN
...
U 1 1 605E6D1D
P 6000 5500
F 0 "#PWR0132" H 6000 5350 50  0001 C CNN
...
U 1 1 605F0B74
P 6000 5750
F 0 "R14" H 6070 5796 50  0000 L CNN
F 1 "220" H 6070 5705 50  0000 L CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 5930 5750 50  0001 C CNN
...
Motor controller power-indicator LED.\nIf illuminated, board is receiving \nhigh-voltage power. 
$EndSCHEMATC
